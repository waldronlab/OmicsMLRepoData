...
write_csv(curated_all, file.path(extDir, "cBioPortal_curated_metadata.csv")) # 189,439 x 172 (from 157)
```
...
dim(cbio_meta_release_tidy) # 189439 x 82: removing non-availability info. Finalize the delimiter and use this as 'release'
```
