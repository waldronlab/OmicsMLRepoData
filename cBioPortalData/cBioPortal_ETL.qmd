...
write_csv(curated_all, file.path(extDir, "cBioPortal_curated_metadata.csv")) # 189,439 x 156
```
...
write.csv(cbio_meta_release, fpath, row.names = FALSE) # 189,439 x 85
...
write.csv(country_map, file.path(cbio_maps_dir, "cBioPortal_location_map.csv"), row.names = FALSE)
