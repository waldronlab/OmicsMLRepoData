...
write.csv(cbio_meta_release_tidy, fpath_tidy, row.names = FALSE) # 189,439 x 58

## Sync the version in GCS bucket
AnVIL::gsutil_cp(fpath, "gs://omics_ml_repo/cBioPortal_curated_metadata_release_tidy.csv")
```
