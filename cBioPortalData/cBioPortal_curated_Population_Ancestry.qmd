...
write.csv(pop_a_discreps, 
          file = file.path(proj_dir, "population_ancestry_discrepancies.csv"),
          row.names = FALSE)
```
...
pop_ancestry_discrep <- read.csv(file=file.path(proj_dir, "cBioPortal_pop_ancestry_discrepancies_map.csv"))
