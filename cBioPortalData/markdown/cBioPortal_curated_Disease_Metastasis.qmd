...
for (x in 1:length(disease_cols_cbio$merged)){
  ...
  new_term_ids <- format_list(list_drop_empty(new_term_ids), "<;>")
   new_terms2 <- lapply(original_terms, function(y) format_list(list_drop_empty(as.list(mapped_terms2$curated_ontology[grep(paste("^",y,"$",sep=""), mapped_terms2$original_value, fixed=F)])), "<;>"))
  new_term_ids2 <- lapply(original_terms, function(y) format_list(list_drop_empty(as.list(mapped_terms2$curated_ontology_term_id[grep(paste("^",y,"$",sep=""), mapped_terms2$original_value, fixed=F)])), "<;>"))
  new_terms2 <- format_list(list_drop_empty(new_terms2), "<;>")
  new_term_ids2 <- format_list(list_drop_empty(new_term_ids2), "<;>")
  ...
  disease_cols_cbio$curated_disease_metastasic_site[x] <- format_list(as.list(unlist(strsplit(new_terms2, "<;>"))), "<;>")
  disease_cols_cbio$curated_disease_metastasic_site_ontology_term_id[x] <- format_list(as.list(unlist(strsplit(new_term_ids2, "<;>"))), "<;>")
