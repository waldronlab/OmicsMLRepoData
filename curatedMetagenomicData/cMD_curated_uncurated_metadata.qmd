...
# Take out NA values
uncurated_cols$original_uncurated_metadata <- gsub("NA;", "", uncurated_cols$original_uncurated_metadata)
uncurated_cols$original_uncurated_metadata <- gsub(";NA", "", uncurated_cols$original_uncurated_metadata)
uncurated_cols$original_uncurated_metadata <- gsub("NA", NA, uncurated_cols$original_uncurated_metadata)
...
# Take out NA values
uncurated_cols$curated_uncurated_metadata <- gsub("NA;", "", uncurated_cols$curated_uncurated_metadata)
uncurated_cols$curated_uncurated_metadata <- gsub(";NA", "", uncurated_cols$curated_uncurated_metadata)
uncurated_cols$curated_uncurated_metadata <- gsub("NA", NA, uncurated_cols$curated_uncurated_metadata)
```
