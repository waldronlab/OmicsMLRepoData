...
author: "Madelyn Carlson and Sehyun Oh"
...
ont_complete <- rename(ont_complete, Full.Name.Curated = Full.Name)
## Merge curated data with the cleaned DF
cMD_disease <- full_join(manual_curated, ont_complete, by = NULL)
## Save
write.csv(cMD_disease, "maps/cMD_disease_ontology.csv", row.names = FALSE)
```
