...
for (i in seq_len(nrow(sampleMetadata))){
...
colnames(curated_study_condition)[2:5] <- c("original_control", "original_disease", "curated_control", "curated_control_ontology_term_id")
```
