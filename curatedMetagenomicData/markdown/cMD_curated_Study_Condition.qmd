...
curated_study_condition <- data.frame(sampleMetadata[,c("curation_id", "study_condition")], disease_data[,c("merged", "control", "control_ontology_term_id","curated_control_source", "curated_target_condition", "curated_target_condition_ontology_term_id", "curated_disease", "curated_disease_ontology_term_id", "curated_disease_source")])

# Rename the columns for accuracy & specificity
colnames(curated_study_condition)[2:7] <- c("original_control", "original_disease", "curated_control", "curated_control_ontology_term_id")
```
