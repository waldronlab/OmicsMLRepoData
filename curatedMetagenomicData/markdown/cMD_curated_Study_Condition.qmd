...
study_condition_ontology <- read_sheet(ss, sheet = "disease_map")
...
`disease_ontology_map`. To access the manually-curated target condition(s) 
...
curated_study_condition <- data.frame(sampleMetadata[,c("curation_id", "study_condition", "disease", "disease_subtype", "history_of_periodontitis")], disease_data[,c("control", "control_ontology_term_id","curated_control_source", "curated_target_condition", "curated_target_condition_ontology_term_id", "curated_disease", "curated_disease_ontology_term_id", "curated_disease_source")])

# Rename the columns for accuracy & specificity
colnames(curated_study_condition)[2:7] <- c("original_study_condition_value", "original_disease_value", "original_disease_subtype_value", "original_history_of_periodontitis_value", "curated_control", "curated_control_ontology_term_id")
```
