---
title: "curatedMetagenomicData Results for the AI/ML manuscript"
author: Sehyun Oh
...
curated_tb <- data.frame(
    ...
    getLongMetaTb(targetCols = colnames(.), delim = ";")
...
```{r completeness_plot_with_subset, echo=FALSE, fig.width=2.2, fig.height=3.2}
attrs_selected <- c("biomarker", "hla", "smoker")
