---
title: "Plot cMD metadata compression summary"
author:
  - Sehyun Oh
...
pick <- c("body_site", "age_group", "disease", "treatment", "fmt_role")
dat <- rbind(correction_tb, correction_tb2) %>%
    filter(curated_column %in% pick)
